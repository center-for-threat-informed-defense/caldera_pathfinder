...
class CragService:
    ...
    # need to move this out to a nmap scanner class and dedicate the crag service to just report parsing to facts linking hosts to CVEs
    ...
    async def scan_network(self):
        ...
        scan_result = {host: await self.scan_host(host) for host in hosts}
        return scan_result

    async def import_scan(self, scan_format, file):
        pass
